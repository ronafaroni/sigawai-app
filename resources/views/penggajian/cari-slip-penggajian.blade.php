                ...
                <div class="card-body">
                    <form action="{{ route('hasil-cari-slip') }}" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="input-block mb-3 row">
                            <label class="col-form-label col-md-2">Tahun Penggajian <span
                        ...
                        <div class="input-block mb-3 row">
                            <label class="col-form-label col-md-2">Bulan Penggajian <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-10">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-search me-2"
                                    aria-hidden="true"></i>Pencarian Data</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                if (year) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.length > 0) {
                                $.each(data, function(key, value) {
                                    $('#bulan').append('<option value="' + value +
                                        '">Bulan ' + value + '</option>');
                                });
                            } else {
                                $('#bulan').append(
                                    '<option value="">Bulan Tidak Ditemukan</option>');
                            }
                        },
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.length > 0) {
                                ...
                                $('#nama').append(
                                    '<option value="">Nama Pegawai Tidak Ditemukan</option>'
                                    );
                            }
                        },
                        error: function(xhr, status, error) {
