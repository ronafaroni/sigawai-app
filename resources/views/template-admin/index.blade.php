					...
					<div id="sidebar-menu" class="sidebar-menu">
						<nav class="greedys sidebar-horizantal">
							<ul class="list-inline-item list-unstyled links">
								...
								<li class="submenu">
									<a><i class="fe fe-users"></i> <span> Manajemen Pegawai</span> <span class="menu-arrow"></span></a>
									<ul>
										<li><a href="{{ route('daftar-pegawai') }}" class="{{ request()->routeIs('daftar-pegawai') ? 'active' : '' }}">Data Pegawai</a></li>
										<li><a href="{{ route('status-pegawai') }}" class="{{ request()->routeIs('status-pegawai') ? 'active' : '' }}">Status Pegawai</a></li>
										<li><a href="{{ route('daftar-akun-users') }}" class="{{ request()->routeIs('daftar-akun-users') ? 'active' : '' }}">Akun Pegawai</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a><i class="fe fe-calendar"></i> <span> Absensi & Kehadiran</span> <span class="menu-arrow"></span></a>
									<ul>
										<li><a href="{{ route('rekap-kehadiran') }}" class="{{ request()->routeIs('rekap-kehadiran') ? 'active' : '' }}">Rekap Kehadiran</a></li>
										<li><a href="{{ route('pengajuan-izin-cuti') }}" class="{{ request()->routeIs('pengajuan-izin-cuti') ? 'active' : '' }}">Pengajuan Izin & Cuti</a></li>
										<li><a href="#">Absensi Manual</a></li>
									</ul>
								</li>
								<li class="submenu">
									<a><i class="fe fe-shopping-bag"></i> <span> Penggajian</span> <span class="menu-arrow"></span></a>
									<ul style="display: none;">
										<li><a href="{{ route('daftar-penggajian') }}" class="{{ request()->routeIs('daftar-penggajian') ? 'active' : '' }}">Daftar Penggajian</a></li>
										<li><a href="{{ route('rekap-penggajian') }}" class="{{ request()->routeIs('rekap-penggajian') ? 'active' : '' }}">Rekap Pengajian</a></li>
										<li><a href="{{ route('cari-slip-penggajian') }}" class="{{ request()->routeIs('cari-slip-penggajian') ? 'active' : '' }}">Slip Penggajian</a></li>
									</ul>
								</li>
								<li>
									<a href="{{ route('daftar-informasi') }}" class="{{ request()->routeIs('daftar-informasi') ? 'active' : '' }}"><i class="fe fe-bell"></i> <span>Notifikasi & Informasi</span></a>
								</li>						
								<li class="menu-title"><span>Settings</span></li>
								<li>
									<a href="{{ route('daftar-akun') }}" class="{{ request()->routeIs('daftar-akun') ? 'active' : '' }}"><i class="fe fe-settings"></i> <span>Manajemen Akun</span></a>
								</li>						
								<li>
									...
									<a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
										<i class="fe fe-power"></i> <span>Keluar</span></a>
									</a>
								</li>
							</ul>
						</nav>
						...
						<ul class="sidebar-vertical">
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="{{ route('daftar-penggajian') }}" class="{{ request()->routeIs('daftar-penggajian') ? 'active' : '' }}">Daftar Penggajian</a></li>
									<li><a href="{{ route('rekap-penggajian') }}" class="{{ request()->routeIs('rekap-penggajian') ? 'active' : '' }}">Rekap Penggajian</a></li>
									<li><a href="{{ route('cari-slip-penggajian') }}" class="{{ request()->routeIs('cari-slip-penggajian') ? 'active' : '' }}">Slip Penggajian</a></li>
								</ul>
							</li>
                            <li>
